...
namespace Paper.Core.VirtualDom
{
    ...
    public sealed class Props
    {
        ...
        /// <summary>Sprite: the part of the sheet to draw (a grid cell or a pixel rectangle); null if unset.</summary>
        public SpriteSlice?          Slice        => _data.TryGetValue("slice", out var s) && s is SpriteSlice slice ? slice : null;
