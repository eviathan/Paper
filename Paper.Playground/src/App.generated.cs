                            ...
                            new PropsBuilder()
                                ...
                                .Children(
                                    new UINode(
                                        ...
                                        new PropsBuilder()
                                            .ClassName("section-label")
                                            .Text("react-icons — 50,388 icons from 31 sets")
                                            .Build()
                                    ),
                                    UI.Box(
                                        new PropsBuilder()
                                            ...
                                            .Children(
                                                ...
                                                new UINode(
                                                    ...
                                                    new PropsBuilder()
                                                        ...
                                                        .Text(
                                                            "Bootstrap · Feather · Lucide · Remix · Heroicons · Tabler"
                                                        )
                                                        .Build()
                                                ),
                                                UI.Box(
                                                ...
                                                new UINode(
                                                    ...
                                                    new PropsBuilder()
                                                        ...
                                                        .Text(
                                                            "Flat Color (fc) — full multi-colour SVG rasterization"
                                                        )
                                                        .Build()
                                                ),
                                                UI.Box(
                                                    ...
                                                    new PropsBuilder()
                                                        ...
                                                        .Children(
                                                            UI.Button(
                                                                ...
                                                                () =>
                                                                {
                                                                    Paper.Rendering.Silk.NET.NativeFileDialog.OpenFile(
                                                                        path =>
                                                                            setOpenedPath(
                                                                                path
                                                                                    ?? "(cancelled)"
                                                            ...
                                                            UI.Button(
                                                                ...
                                                                () =>
                                                                {
                                                                    Paper.Rendering.Silk.NET.NativeFileDialog.SaveFile(
                                                                        path =>
                                                                            setSavedPath(
                                                                                path
                                                                                    ?? "(cancelled)"
