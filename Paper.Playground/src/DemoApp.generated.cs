                                            ...
                                            .Children(
                                                UI.Nodes(
                                                    UI.Icon(
                                                        IconSets.Fa.FaHome,
                                                        24,
                                                        new PaperColour(0.55f, 0.78f, 1f, 1f)
                                                    ),
                                                    UI.Icon(
                                                        IconSets.Fa.FaGithub,
                                                        24,
                                                        new PaperColour(0.8f, 0.8f, 0.8f, 1f)
                                                    ),
                                                    UI.Icon(
                                                        IconSets.Md.MdSettings,
                                                        24,
                                                        new PaperColour(0.4f, 0.8f, 0.4f, 1f)
                                                    ),
                                                    UI.Icon(
                                                        IconSets.Bs.BsStarFill,
                                                        24,
                                                        new PaperColour(1f, 0.8f, 0.2f, 1f)
                                                    ),
                                                    UI.Icon(
                                                        IconSets.Hi.HiHeart,
                                                        24,
                                                        new PaperColour(0.9f, 0.3f, 0.3f, 1f)
                                                    ),
                                                    UI.Icon(
                                                        IconSets.Fi.FiDownload,
                                                        24,
                                                        new PaperColour(0.6f, 0.9f, 0.6f, 1f)
                                                    ),
                                                    UI.Icon(
                                                        IconSets.Lu.LuSearch,
                                                        24,
                                                        new PaperColour(0.8f, 0.6f, 1f, 1f)
                                                    ),
                                                    UI.Icon(
                                                        IconSets.Tb.TbBrandGithub,
                                                        24,
                                                        new PaperColour(0.9f, 0.5f, 0.2f, 1f)
                                                    ),
                                                    UI.Icon(
                                                        IconSets.Ri.RiAlarmLine,
                                                        24,
                                                        new PaperColour(1f, 0.4f, 0.6f, 1f)
                                                    ),
