    ...
    new PropsBuilder()
        ...
        .Children(
            ...
            new PropsBuilder()
                ...
                .Text("Hello World!")
                .Build()),
            UI.Button("Click Me", () => { System.Console.WriteLine("Button clicked!"); }, new StyleSheet { Background = new PaperColour(0.05882353f, 0.20392157f, 0.3764706f, 1f), Color = new PaperColour(1f, 1f, 1f, 1f), Padding = new Thickness(Length.Px(12), Length.Px(24)), BorderRadius = 6f, FontSize = Length.Px(16) })
        )
        .Build());
    }
}
